...
import {postControl, auth} from '../api'
...
export default function Comments(props) {
    ...
    return (<div>
        <CardHeader
            avatar={
                <Avatar className={classes.smallAvatar}
                        src={'/api/resources/photo/' + auth.isAuthenticated().user._id}/>
            }
            title={<TextField
        ...
        {props.comments.map((item, i) => {
            return <CardHeader
                avatar={
                    <Avatar className={classes.smallAvatar} src={'/api/resources/photo/' + item.postedBy._id}/>
                }
